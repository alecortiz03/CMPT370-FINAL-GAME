...
class MapRenderer:
    def __init__(self, engine):
        ...
        # Remapping vertex coordinates to screen coordinates
        self.vertexes = [pg.math.Vector2(self.remap_x(v.x), self.remap_y(v.y))
                         for v in self.vertexes]

    def draw(self):
        pass
        # Uncomment the following lines to enable drawing
        # self.draw_linedefs()
        # self.draw_vertexes()
    ...
    def draw_seg(self, seg, sub_sector_id):
        ...
        # Draw a line segment between two vertices
    ...
    def draw_node(self, node_id):
        ...
        # Uncomment the following lines to draw bounding boxes
        ...
        # Draw the partition line of the node
    ...
    def draw_player_pos(self):
        ...
        pg.draw.circle(self.engine.screen, 'orange', (x, y), 4)
    ...
    def remap_x(self, n, out_min=30, out_max=WIDTH-30):
        # Remap x coordinate to screen space
    ...
    def remap_y(self, n, out_min=30, out_max=HEIGHT-30):
        # Remap y coordinate to screen space
